...
import org.scalatest.{Ignore, BeforeAndAfterAll, Matchers, WordSpec}
import org.apache.zookeeper.{CreateMode, ZooKeeper}
import com.alexb.test.Config
import org.apache.zookeeper.ZooDefs.Ids

@Ignore
class ZkPropertiesSpec extends WordSpec with BeforeAndAfterAll with Matchers with Config {
